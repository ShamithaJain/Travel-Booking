...
TEMPLATES = [
    {
        ...
        'DIRS': [BASE_DIR / "templates"],   # so you can keep project-wide templates
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = 'shamithajain04@gmail.com'
EMAIL_HOST_PASSWORD = 'doghbreymwjykdpx'  # not your normal password
